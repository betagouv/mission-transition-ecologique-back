...
| `docs/adr/0009-document-locking-and-review-comments.md` | Verrouillage de document (`lockDocuments` natif Payload, accès exclusif pendant l'édition) et commentaires de relecture (champ `array` `reviewComments` en sidebar sous la description SEO, auteur/date horodatés par le hook `stampReviewComments`) |
