...
export default {
  ...
  "path": "https://github.com/etalab/schema-dispositif-aide/raw/v0.2.0/build/dispositif-aide/schema.json",
  "licenses": [
    {
  ...
  "resources": [
    {
      ...
      "path": "https://github.com/etalab/schema-dispositif-aide/raw/v0.2.0/exemple-valide.csv"
    }
  ],
  "sources": [],
  "created": "2022-03-14",
  ...
  "contributors": [
    {
      "title": "Thibaut Tezenas",
      "email": "thibaut.tezenas@murmures.coop",
    ...
    {
      "title": "David Guillot",
      "email": "david.guillot@ext.beta.gouv.fr",
